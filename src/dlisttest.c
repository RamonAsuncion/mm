 ...
 * Modifications Copyright (c) 2025 Ramon Asuncion
 *
...
int main(int argc, char *argv[]) {
  ...
  dlist_add_back(mylist, str1, strlen(str1) + 1);
  dlist_add_back(mylist, str2, strlen(str2) + 1);
  dlist_add_back(mylist, str3, strlen(str3) + 1);
  dlist_add_back(mylist, str4, strlen(str4) + 1);
  dlist_add_back(mylist, str5, strlen(str5) + 1);
  ...
  dlist_add_front(mylist, str1, strlen(str1) + 1);
  dlist_add_front(mylist, str2, strlen(str2) + 1);
  dlist_add_front(mylist, str3, strlen(str3) + 1);
  dlist_add_front(mylist, str4, strlen(str4) + 1);
  dlist_add_front(mylist, str5, strlen(str5) + 1);
